...
public class ISub 
{
	static Logger logger = Logger.getLogger(ISub.class);
...
//    	ArrayList<String> l0 = NlpAgent.getStemmedSentence("Prostatic Epithelium"), l1 = NlpAgent.getStemmedSentence("prostate gland epithelium");
//    	String s0 = "", s1 = "";
//    	for(String s :l0)
//    		s0 += s + " ";
//    	for(String s : l1)
...
//    	System.out.println(ISub.getSimilarity(s0, s1));
    	System.out.println(ISub.getSimilarity("Plugins", "Plug-ins"));
    }
}